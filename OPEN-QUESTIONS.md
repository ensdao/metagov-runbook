...
- **Q-01 — Term 7 election outcome.** Final Meta-Gov stewards, Lead Steward, and Secretary are undecided — voting runs 25–30 Jun 2026. Four nominees for 3 seats: estmcmxci.eth, jkm.eth, sovereignsignal.eth, vegayp.eth. ([noms thread 22157](https://discuss.ens.domains/t/meta-governance-working-group-steward-nominations-term-7-2026/22157)) → resolve after 30 Jun.
...
- **Q-03 — Meta-Gov multisig 3/4 → 2/3.** The Path-forward thread indicates a move toward 2-of-3 signing with the Secretary seat optional. The Safe is currently 3/4 — re-verify the owner set/threshold on-chain after the Term 7 transition.
