...
**Resolved for Term 7 (verified on-chain 2026-08-19):** the Safe is **2 of 4**, not the 2-of-3 the ["Path forward"](https://discuss.ens.domains/t/path-forward-on-working-groups-for-term-7/22107) thread anticipated. The fourth seat is held by the DAO Timelock rather than a Secretary. See [multisigs.md](../02-contracts-and-multisigs/multisigs.md).
