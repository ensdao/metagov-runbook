...
| --- | --- | --- | --- | --- | --- | --- |
| **Social** | [Snapshot](https://snapshot.box/#/s:ens.eth) (off-chain) | — | 1% | 50% | ~5 days | Binding socially; no on-chain execution. |
...
| **Constitutional** | Snapshot (special social proposal, with a diff) | — | 1% | **Two-thirds** | — | Amends the [Constitution](constitution.md). |
